...
def problem1(square, thickness, window):
    ...
    cent_circle_x = square.center.x
    cent_circle_y = square.center.y + square.length_of_each_side

    circle = rg.Circle(rg.Point(cent_circle_x,cent_circle_y),0.5 * square.length_of_each_side)

    circle.fill_color = square.fill_color
    circle.outline_thickness = thickness


    line = rg.Line(rg.Point(cent_circle_x,cent_circle_y),rg.Point(square.center.x - (0.5 * square.length_of_each_side),square.center.y))
